...
-- After running, insert the owner e-mail with service role/admin privileges:
-- insert into public.admin_emails (email) values ('seu-email-admin@exemplo.com') on conflict do nothing;
